package bd.service.interceptors;
...
import bd.service.api.resp.RespCodeConstant;
...
public class LogInterceptor {
	 ...
	 */
	@Pointcut("execution(* bd.service.report.engine.api.*.*(..)) and @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	...
	public Object doAround(ProceedingJoinPoint pjp) {
		...
		try {
			...
			LOG.error(methodName+ ">>" + "请求异常，耗时：" + costMs + "ms" + "；" + "异常信息：" + result.getRespDesc());
		}
		long costMs = System.currentTimeMillis() - startTime;
		LOG.info(methodName+ ">>" + "请求结束，耗时：" + costMs + "ms" + "；" + "备注/异常信息：" + result.getRespDesc());
		return result;
	}
